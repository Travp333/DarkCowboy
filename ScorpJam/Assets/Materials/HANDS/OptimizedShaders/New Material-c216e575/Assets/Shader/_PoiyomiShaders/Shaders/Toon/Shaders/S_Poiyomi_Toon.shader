Shader "Hidden/.poiyomi/• Poiyomi Toon •/New Material-c216e575"
{
    Properties
    {
...
#define PROP_MAINEMISSIONSTRENGTH 0.59
#define PROP_BUMPMAP
#define PROP_BUMPMAPUV 0
#define PROP_BUMPSCALE 0.77
...
#define PROP_SPECULARSMOOTHNESS 0.194
