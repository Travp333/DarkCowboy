    ...
    float4 frag(v2f i, uint facing: SV_IsFrontFace): SV_Target
    {
        ...
        **********************************************************************/
            ...
            #ifdef POI_SPECULAR
                meta.SpecularColor = poiLight.color.rgb * float4(1,1,1,1).rgb * lerp(1, albedo.rgb, float(0.213)) * float4(1,1,1,1).a;
            #else
        ...
        **********************************************************************/
        ...
        #ifdef FORWARD_ADD_PASS
            //finalColor.rgb = smoothstep(float(0), float(0.06), 1 - (.5 * poiLight.nDotL + .5));
        #endif
