    ...
    void calculateVertexLightingData(in v2f i)
    {
            ...
            for (int index = 0; index < 4; index ++)
            {
                ...
                if (float(1) == 1)
                {
                    ...
                    poiLight.vColor[index] = min(poiLight.vColor[index], poiLight.vColor[index] / (intensity / float(2.09)));
                }
    ...
    void calculateLightingData(in v2f i)
    {
            ...
            poiLight.color = magic + normalLight;
                ...
                if (float(1) == 1)
                {
                    ...
                    poiLight.color = min(poiLight.color, poiLight.color / (additiveLightIntensity / float(2.09)));
                }
            #endif
        #endif
