Shader "Hidden/.poiyomi/• Poiyomi Toon •/GoopDecal4-4177a6e8"
{
    Properties
    {
...
#define PROP_SATURATION 0.381
#define PROP_MAINEMISSIONSTRENGTH 3.38
#define PROP_BUMPMAP
#define PROP_BUMPMAPUV 0
#define PROP_BUMPSCALE 0.1
...
#define PROP_SPECULARTOONSTART 0.849
#define PROP_SPECULARTOONEND 1.522
