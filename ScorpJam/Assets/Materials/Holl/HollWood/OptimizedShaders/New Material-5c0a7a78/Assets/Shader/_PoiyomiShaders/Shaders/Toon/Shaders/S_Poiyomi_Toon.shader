Shader "Hidden/.poiyomi/• Poiyomi Toon •/New Material-5c0a7a78"
{
    Properties
    {
...
#define PROP_SPECULARMETALLIC 0.39
#define PROP_SPECULARMETALLICMAPUV 0
#define PROP_SPECULARSMOOTHNESS 0.685
...
#define PROP_OUTLINETINTMIX 0.156
